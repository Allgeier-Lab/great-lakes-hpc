...
Once you have `rslurm_template` within your local disk, you will need to use a program such as `FileZilla` or `CyberDuck` to copy the rslurm_template to HPC
  for exmaple on `FileZilla`, go to `File` > `Site Manager` > and log in to HPC
